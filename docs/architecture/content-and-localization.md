...
The manifest records assets as `pending`, `candidate`, `approved`, or `unavailable`. Pending and unavailable assets have no source path. Only approved project-relative paths may be rendered as final media.
