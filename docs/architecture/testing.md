...
The landing-page manifest tests enforce section order and uniqueness, asset
identity and status rules, project-relative candidate and approved sources that
resolve to real files under `public/`, resolvable locale keys,
navigation-anchor uniqueness, and valid unresolved-decision references. Catalog
parity remains mandatory while English landing copy is marked as pending
