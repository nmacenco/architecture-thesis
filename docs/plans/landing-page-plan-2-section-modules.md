...
> Status: in progress — first six modules implemented · Last updated: 2026-09-13
...
established. `hero`, `concept`, `site`, `references`, `process`, and `programme`
are extracted Tailwind-styled Server Components, completing the second, third,
and fourth construction groups. The remaining sections stay in the legacy inline
route until their own bounded module work is completed.
