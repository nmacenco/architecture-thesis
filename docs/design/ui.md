...
Images structure the reading experience. Until final assets exist, use identifiable placeholders that must be replaced by renders, plans, diagrams, or photographs while preserving their proportions and alt text. When a bounded editorial review explicitly needs configured candidate images in context, show them only with their manifest statuses preserved and a persistent translated pending treatment. A visually grouped sequence may use one quiet shared marker when every preview remains unambiguously associated with it, including for assistive technology.
